		...
		<table class="table">
		    ...
		    <c:forEach items="${books}" var="book">
		        <tr>
		            ...
		            <td>${book.title}</td>
		            <td>${book.author}</td>
		            <td><a href="<c:url value='/editV1/${book.id}' />" >Edit</a></td>
		            <td><a href="<c:url value='/removeV1/${book.id}' />" >Delete</a></td>
		        </tr>
		    </c:forEach>
		    </table>
		</c:if>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <c:url var="addAction" value="/create-bookV1" ></c:url>
		     <form:form modelAttribute="book" action="${addAction}" commandName="book" method="POST" id="bookForm">
				<table>
